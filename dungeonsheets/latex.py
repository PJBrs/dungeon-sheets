...
def rst_to_latex(rst, top_heading_level: int=0, format_dice: bool = True, use_dnd_decorations=False):
    ...
    if use_dnd_decorations:
        ...
        for header in tableheader:
            ...
            colwidths = [float(width) for width in re.findall(r"0\.[0-9]+", str(header))]
            tablewidth = 0
            ...
            for width in colwidths:
                ...
                transformed_width = round( width / tablewidth, 3)
                ...
                transformed_header = re.sub(str(width) + r"\\DUtablewidth",
                                            transformed_width,
                                            transformed_header)
