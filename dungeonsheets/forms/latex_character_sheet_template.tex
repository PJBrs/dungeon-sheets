...
[[- char.attacks_and_spellcasting| rst_to_latex(format_dice=False) -]]}
...
[[ char.equipment_text| rst_to_latex ]]

\footnotesize{[[ char.weight_and_capacity_text| rst_to_latex ]]}}

\PersonalityTraits{[[ char.personality_traits| rst_to_latex ]]}

\Ideals{[[ char.ideals| rst_to_latex ]]}

\Bonds{[[ char.bonds| rst_to_latex ]]}

\Flaws{[[ char.flaws| rst_to_latex ]]}

\FeaturesTraits{\setlength{\parindent}{0cm}

[[ char.features_summary| rst_to_latex ]]}
...
[[- char.appearance_text| rst_to_latex -]]
}
\AdditionalFeaturesAndTraits{[[ char.additional_description| rst_to_latex ]]}

\Characterbackground{[[ char.backstory| rst_to_latex ]]}

\Treasure{[[ char.treasure| rst_to_latex ]]}

\AlliesAndOrganizations{[[ char.allies| rst_to_latex ]]}

\OrganizationName{[[ char.org_name| rst_to_latex ]]}
