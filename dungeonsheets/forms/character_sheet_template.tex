...
% Set font for labels to Kalam
\setlist{font=\entryfont, noitemsep}

% Temporarily improve bullets
\setitemize{label=\normalsize\textbf{\textbullet}}
...
[% endfor %]
\AttacksAdditional{\setlength{\parindent}{0cm}

[% if character.armor %]\textbf{Armor}: [[ character.armor ]]

[% endif -%][%- if character.shield %]\textbf{Shield}: [[ character.shield ]]

[% endif -%][[ character.attacks_and_spellcasting| rst_to_latex(format_dice=False) ]]}

\OtherProficienciesLanguages{\setlength{\parindent}{0cm}

\textbf{Languages:} [[ character.languages ]].
...
\Equipment{\setlength{\parindent}{0cm}
[[ character.equipment_text| rst_to_latex ]]

\footnotesize{[[ character.weight_and_capacity_text| rst_to_latex ]]}}

\PersonalityTraits{[[ character.personality_traits| rst_to_latex ]]}

\Ideals{[[ character.ideals| rst_to_latex ]]}

\Bonds{[[ character.bonds| rst_to_latex ]]}

\Flaws{[[ character.flaws| rst_to_latex ]]}

\FeaturesTraits{\setlength{\parindent}{0cm}
[[ character.features_summary| rst_to_latex ]]}
...
\CharacterAppearance{[[ portrait ]][[ character.appearance_text| rst_to_latex ]]}

\AdditionalFeaturesAndTraits{[[ character.additional_description| rst_to_latex ]]}

\Characterbackground{[[ character.backstory| rst_to_latex ]]}

\Treasure{[[ character.treasure| rst_to_latex ]]}

\AlliesAndOrganizations{[[ character.allies| rst_to_latex ]]}

\OrganizationName{[[ character.org_name| rst_to_latex ]]}

\OrganizationSymbol{[[ symbol ]]}
...
\setlist{font=\bfseries, noitemsep}

% Reset bullets for itemize
