...
class AntimagicField(Spell):
    ...
    Targeted Effects.
      Spells and other magical effects, such as magic missile and charm
    ...
    Magic Items.
      ...
      sphere. For example, a +1 longsword in the sphere functions as a
      ...
      the sphere), the magic of the item ceases to be suppressed as
      soon as it exits.
    Magical Travel.
...
class Antipathysympathy(Spell):
    ...
    Sympathy.
      ...
      such a creature can see the target or comes within 60 feet of it, the creature
...
class AuraOfLife(Spell):
    ...
    regains 1 hit point when it starts its turn in the aura with 0 hit points.
...
class AuraOfPurity(Spell):
    ...
    following conditions: blinded, charmed, deafened, frightened, paralyzed,
...
class Awaken(Spell):
    ...
    roots, vines, creepers, and so forth, and it gains senses similar to a human's.
